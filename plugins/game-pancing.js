       ...
       let type = (args[0] || '').toLowerCase()
        switch (type) {
	          case 'easy':
                                  ...
                                  if (pancingan == 0 || umpan == 0) return m.reply('*Kamu Belum Memiliki Pancingan Dan Umpan, Silahkan Beli Di #shop*')
...
`.trim()
                                ...
                                setTimeout(() => {
                                m.reply(`*Saatnya Mancing Mode Easy Lagi*`)
                                }, 28800000) 
                                setTimeout(() => {
                                m.reply(`${hsl}`)
                                }, 12000) 
                                ...
                                m.reply('*⌚ Menunggu*')
                                 ...
                                 } else conn.reply(m.chat, 'Minimal Jumlah Umpan  *100* Untuk Memancing Level Easy, Silahkan Beli Di #shop', m)
                            } else conn.reply(m.chat, 'Minimal Pancingan Kamu *Level 2* Untuk Memancing Level Easy', m)
...
`.trim()
                                ...
                                setTimeout(() => {
                                m.reply(`*Saatnya Memancing Mode Normal Lagi*`)
                                }, 28800000) 
                                setTimeout(() => {
                                m.reply(`${hsls}`)
                                }, 12000) 
                                ...
                                m.reply('*⌚ Menunggu*')
                                 ...
                                 user.lastmancingeasy = new Date * 1
                                 } else conn.reply(m.chat, 'Minimal Jumlah Umpan Kamu *150* Untuk Memancing Level Normal', m)
...
`.trim()
                                ...
                                setTimeout(() => {
                                m.reply(`*Saatnya Memancing Mode Hard Lagi*`)
                                }, 28800000) 
                                setTimeout(() => {
                                m.reply(`${hslsh}`)
                                }, 12000) 
                                ...
                                m.reply('*⌚ Menunggu*')
                                 ...
                                 user.lastmancingeasy = new Date * 1
                                 } else conn.reply(m.chat, 'Minimal Jumlah Umpan Kamu *200* Untuk Memancing Level Hard', m)
...
`.trim()
                                ...
                                setTimeout(() => {
                                m.reply(`*Saatnya Memancing Mode Extreme Lagi*`)
                                }, 28800000) 
                                setTimeout(() => {
                                m.reply(`${hslse}`)
                                }, 12000) 
                                ...
                                m.reply('*⌚ Menunggu*')
                                 ...
                                 user.lastmancingeasy = new Date * 1
                                 } else conn.reply(m.chat, 'Minimal Jumlah Umpan Kamu *250* Untuk Memancing Level Extreme', m)
