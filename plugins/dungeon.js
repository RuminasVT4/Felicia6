...
`.trim()
        ...
        setTimeout(async () => {
          ...
          let str2 = `
*「 DUNGEON BATTLES  」*\n
Health *${M(p1)}*, *${M(p2)}*, *${M(p3)}* Dan *${M(p4)}* Masing Masing Berkurang *-${health * 1}*, Dan Durability Sword Kalian Masing-Masing Berkurang *-${sword * 1}* Karena Kalian Telah Membunuh *${pickRandom(['', 'Rimuru Tempest', 'Anos Voldigoad', 'Sai Akuto', 'Naruto', 'Azathoth', 'Bondye', 'CORE', 'Dr. Bright', 'Jehovah', 'Judy', 'Veldanava', 'SCP-001', 'SCP-2719', 'SCP-2747', 'The Writer', 'Keluarga Sendiri', 'Diri Sendiri', 'Jiwa Sendiri','Mantan'])}*\n\n🎁Dungeon Result
*• Exp:* ${exp * 4}
*• Money:* ${money * 4}
...
*• Sampah:* ${sampah  * 4}${potion == 0 ? '' : '\n*• Potion:* ' + potion * 4}${makananPet == 0 ? '' : '\n*• Makanan Pet* ' + makananPet * 4}${kayu == 0 ? '' : '\n*• Kayu:* ' + kayu * 4}${batu == 0 ? '' : '\n*• Batu:* ' + batu * 4}${string == 0 ? '' : '\n*• String:* ' + string * 4}${iron == 0 ? '' : '\n*• Iron:* ' + iron * 4}${diamond == 0 ? '' : '\n*• Diamond:* ' + diamond * 4}${common == 0 ? '' : '\n*• Common Crate:* ' + common * 4}${uncommon == 0 ? '' : '\n*• Uncommon Crate:* ' + uncommon * 4}
        ...
        const buttons = [
            {buttonId: 'SOLO', buttonText: {displayText: 'sendiri'}, type: 1}
        ]
...
handler.before = function (m) {
  ...
  if (room) {
    ...
    if (/^(sendiri|dewean|solo)$/i.test(m.text.toLowerCase())) {
        const buttons = [
            {buttonId: 'START', buttonText: {displayText: 'gass..'}, type: 1}
        ]
...
`.trim()
      ...
      setTimeout(async () => {
        ...
        let str2 = `
*「 DUNGEON BATTLES  」*\n
Health Kamu Berkurang *-${health * 1}*, Dan Durability Sword Kamu *-${sword * 1}* Karena Kalian Telah Membunuh *${pickRandom(['', 'Rimuru Tempest', 'Anos Voldigoad', 'Sai Akuto', 'Naruto', 'Azathoth', 'Bondye', 'CORE', 'Dr. Bright', 'Jehovah', 'Judy', 'Veldanava', 'SCP-001', 'SCP-2719', 'SCP-2747', 'The Writer', 'Keluarga Sendiri', 'Diri Sendiri', 'Jiwa Sendiri','Mantan'])}*\n\n🎁Dungeon Result
*• Exp:* ${exp}
*• Money:* ${money}
*• Tiketcoin:* ${tiketcoin}
*• Sampah:* ${sampah}${potion == 0 ? '' : '\n*• Potion:* ' + potion}${makananPet == 0 ? '' : '\n*• Makanan Pet* ' + makananPet}${kayu == 0 ? '' : '\n*• Kayu:* ' + kayu}${batu == 0 ? '' : '\n*• Batu:* ' + batu}${string == 0 ? '' : '\n*• String:* ' + string}${iron == 0 ? '' : '\n*• Iron:* ' + iron}${diamond == 0 ? '' : '\n*• Diamond:* ' + diamond}${common == 0 ? '' : '\n*• Common Crate:* ' + common}${uncommon == 0 ? '' : '\n*• Uncommon Crate:* ' + uncommon}
`.trim()
        ...
        if ((users.health * 1) < 1 || (users.sworddurability * 1) < 1) {
          ...
          let str3 = `${__sword1 ? `⚔️ Sword Kamu ${_sword1 ? ` Level Berkurang 1 Karena Hancur` : ` Hancur, Dan Silahkan Memperbaiki Sword Kembali Dengan Mengetik ${usedPrefix}`}meracik sword` : ''} ${health1 ? `${__sword1 ? 'Dan ' : ''}Health Kamu Sedikit, Silahkan Isi Kembali Dengan Ketik ${usedPrefix}heal` : ''}`
          m.reply(str3, room.player1, {
            contextInfo: {
