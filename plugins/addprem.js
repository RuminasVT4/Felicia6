...
let handler = async (m, { conn, text, usedPrefix }) => {
  ...
  if (!text) return conn.reply(m.chat, `*STATUS PREMIUM*\n\n • Example ${usedPrefix}prem number|days\n • Example: ${usedPrefix}prem @Tag|Countdown`, m)
